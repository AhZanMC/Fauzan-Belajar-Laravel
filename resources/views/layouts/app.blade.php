...
<body class="font-sans antialiased bg-gray-100">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-100">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-10">
                <a class="flex items-center px-6 py-2 mt-4 text-gray-100 {{ request()->routeIs('dashboard') ? 'bg-gray-700 bg-opacity-25 border-l-4 border-gray-100' : 'hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100' }}" href="{{ route('dashboard') }}">
